    ...
    final List<Map<String, String>> supportSections = [
      {
        ...
        'content': '''
If you face any technical issues with your rented AC, our dedicated technical support team is here to help. From installation problems to performance issues, you can reach us 24/7 at theaconrent@gmail.com or call +91 9301778661.
...
'''
      },
      {
        ...
        'content': '''
Planning to move to a new location? We’ve got you covered! Our relocation support ensures hassle-free transfer of your rented AC to your new residence or office.

Process:
1. Notify us at least 48 hours before your relocation.
2. Share your new address and preferred relocation time.
3. Our team will dismantle, transport, and reinstall your AC at no additional cost.
...
Services we offer:
1. Clarification of rental charges and invoices.
...
Ensure you have your customer ID or rental agreement details handy for faster resolution.
'''
      },
    ];
