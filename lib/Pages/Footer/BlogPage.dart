...
class BlogPage extends StatelessWidget {
  ...
  Widget _buildBlogContent(bool isSmallScreen) {
    final List<Map<String, String>> blogPosts = [
      ...
      {
        'title': 'The Benefits of Renting an AC vs Buying',
        'content':
            'Renting an AC has many advantages, including affordability, flexibility, and maintenance support. Read more to discover why renting might be the right choice for you.'
      },
      {
